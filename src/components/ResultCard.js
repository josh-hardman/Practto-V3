...
const ResultCard = ({
  ...
  >
    <AvatarWrapper>
      <Avatar height={100} src={url ? url : placeholderImg} />
    </AvatarWrapper>
    <ContentWrapper>
